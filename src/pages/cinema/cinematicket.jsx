...
<div >
    ...
    <button className="flex items-center gap-[6px] text-medium py-3 px-4 rounded-lg bg-button_color"><img src="./image/watch_icon.svg" alt="" />Ждет оплаты</button>
			</div>
   <div className="flex justify-between items-center bg-[#1D1D1D] w-full  py-2 px-4  rounded-b-[12px] absolute left-0 bottom-[-70px]">
...
<div >
    ...
    <ul className="flex gap-[6px] mb-4">
     ...
     <li><p className="text-medium text-[14px] text-textcolor" >RU </p></li>
     <li><p className="text-medium text-[14px] text-textcolor" >•</p></li>
     <li><p className="text-medium text-[14px] text-textcolor" >18+</p></li>
     <li><p className="text-medium text-[14px] text-textcolor" >•</p></li>
    ...
    <button className="flex items-center gap-[6px] text-medium py-3 px-4 rounded-lg bg-button_color"><img src="./image/save_icon.svg" alt="" />Хочу посмотреть</button>
			</div>
